...
int menu() {
    printf("\nMenu: 1) Add Friend; 2) Delete Friend; 3) Show phone book; 4) Find Phone Number; 5) Randomly Call Friend; 6) Delete All Friends; 7) Exit\n");
    int r;
    scanf("%d", &r);
...
int compare_contacts(const void* a, const void* b) {
    ...
    int result = strcmp(contactA->first_name, contactB->first_name);
    if (result == 0) {
